...
from loadData import trainFeatures,trainLabels_8,testFeatures,testLabels_8


#-----读取权重参数路径-----

w1Path = 'E:/workspace for python/Experiment/multimodalExperiment/CICIDS2017/noModalityClaassification/fine_tune/77_60w1.csv'
b1Path = 'E:/workspace for python/Experiment/multimodalExperiment/CICIDS2017/noModalityClaassification/fine_tune/77_60b1.csv'
