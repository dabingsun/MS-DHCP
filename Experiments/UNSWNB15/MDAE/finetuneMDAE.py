...
#-----读取权重参数路径-----
bwloadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/basicRBMPara/169_100_w.csv'
bb1loadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/basicRBMPara/169_100_b1.csv'
bb2loadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/basicRBMPara/169_100_b2.csv'

cwloadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/contentRBMPara/15_10_w.csv'
cb1loadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/contentRBMPara/15_10_b1.csv'
cb2loadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/contentRBMPara/15_10_b2.csv'

twloadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/trafficRBMPara/12_10_w.csv'
tb1loadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/trafficRBMPara/12_10_b1.csv'
tb2loadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/trafficRBMPara/12_10_b2.csv'

w2loadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/multiDBNPara/120_30_w.csv'
b2loadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/multiDBNPara/120_30_b1.csv'
b3loadPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/multiDBNPara/120_30_b2.csv'
...
#    hidden3 = tf.add(tf.matmul(hidden2,ae_w3),ae_b3)
    ...
    bHidden3 = tf.slice(hidden3,[0,0],[-1,100])
    cHidden3 = tf.slice(hidden3,[0,100],[-1,10])
    tHidden3 = tf.slice(hidden3,[0,110],[-1,-1])
