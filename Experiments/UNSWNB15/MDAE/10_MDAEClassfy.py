# -*- coding: utf-8 -*-
"""
Created on Tue Aug 27 21:46:23 2019
...
import time
#-----读取权重参数路径-----
bw1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_60bw1.csv'
bb1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_60bb1.csv'

cw1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_60cw1.csv'
cb1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_60cb1.csv'

tw1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_60tw1.csv'
tb1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_60tb1.csv'

w2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_60w2.csv'
b2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_60b2.csv'
#-----读取数据-----
...
#    hidden2 = tf.nn.relu(tf.add(tf.matmul(hidden1,ae_w2),ae_b2))
#    output = tf.add(tf.matmul(hidden2,ae_w3),ae_b3)
    logits = tf.add(tf.matmul(hidden2,ae_w3),ae_b3)
    y = tf.nn.softmax(logits)
    return logits,y

logits,y = MDAE_inference(basic_x,content_x,traffic_x)
