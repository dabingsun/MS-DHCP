...
#-----读取权重参数路径-----
#wsavePath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/basicRBMPara/12_10_w.csv'
#b1savePath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/basicRBMPara/12_10_b1.csv'
#b2savePath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/basicRBMPara/12_10_b2.csv'

w1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/singleClassfication/01_fine_tune/traffic/w1.csv'
b1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/singleClassfication/01_fine_tune/traffic/b1.csv'
w2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/singleClassfication/01_fine_tune/traffic/w2.csv'
b2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/singleClassfication/01_fine_tune/traffic/b2.csv'

#wsavePath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/contentRBMPara/12_10_w.csv'
#b1savePath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/contentRBMPara/12_10_b1.csv'
#b2savePath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/contentRBMPara/12_10_b2.csv'
