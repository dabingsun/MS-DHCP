...
#-----读取权重参数路径-----
loadwPath = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/noModalityRBMPara/196_90_w.csv'
loadb1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/noModalityRBMPara/196_90_b1.csv'
loadb2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/RBMs/noModalityRBMPara/196_90_b2.csv'

#-----保存权重参数路径-----
w1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/noModalityClaassification/fine_tune/w1.csv'
b1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/noModalityClaassification/fine_tune/b1.csv'
w2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/noModalityClaassification/fine_tune/w2.csv'
b2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/noModalityClaassification/fine_tune/b2.csv'
