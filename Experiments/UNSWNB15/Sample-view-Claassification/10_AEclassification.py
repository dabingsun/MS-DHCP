...
#w2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/singleClassfication/fine_tune/basic/w2.csv'
#b2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/singleClassfication/fine_tune/basic/b2.csv'



#-----读取数据-----
train_x = trainFeatures
train_y = trainLabels_10

test_x = testFeatures
test_y = testLabels_10
