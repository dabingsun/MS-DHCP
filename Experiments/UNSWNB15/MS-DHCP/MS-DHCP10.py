...
from loadData import trainbasicFeatures,traincontentFeatures,traintrafficFeatures,trainLabels_10,testbasicFeatures,testcontentFeatures,testtrafficFeatures,testLabels_10

#MDAE权重参数路径
bw1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_90bw1.csv'
bb1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_90bb1.csv'

cw1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_90cw1.csv'
cb1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_90cb1.csv'

tw1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_90tw1.csv'
tb1Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_90tb1.csv'

w2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_90w2.csv'
b2Path = 'E:/workspace for python/Experiment/multimodalExperiment/UNSWNB15/MDAE/fine_tune/120_90b2.csv'
...
ae_bw1 = tf.Variable(bw1,name="ae_bw1",trainable=True)
ae_bb1 = tf.Variable(bb1,name = "ae_bb1",trainable=True)
...
#        tf.reset_default_graph()
        ...
        self.basic_x =tf.placeholder(dtype = tf.float32,shape=[None,169],name='basic_x')
        self.content_x =tf.placeholder(dtype = tf.float32,shape=[None,15],name='content_x')
        self.traffic_x =tf.placeholder(dtype = tf.float32,shape=[None,12],name='traffic_x')
